<?php 
    ...
    if(isset($_POST['insert'])) {
		if(buat_surat_pensiun($_POST) > 0) {
			echo "
					<script>
						alert ('Surat Pensiun Berhasil Dibuat');
						window.location.href='index.php?page=surat_pensiun';
					</script>
				";
		}else{
			echo "<script>
						alert ('Data Pensiun Gagal Dibuat');
						window.location.href='index.php?page=surat_pensiun';
					</script>
				";
        }
                ...
                <div class="card-body">
                    <form  action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input id="Keterangan" type="text" name="ket" class="form-control" value="pensiun" readonly>
                        </div><br>
