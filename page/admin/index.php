                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-4" class="collapse submenu" style="">
                                    <ul class="navbar-nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="?page=laporan_data_pegawai"><i class="fas fa-file-pdf"></i> Laporan Data Pegawai</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="?page=laporan_absensi_pegawai"><i class="fas fa-file-pdf"></i>Laporan Absen Pegawai</a>
                                        </li>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="?page=hak_akses">
                                    <i class="fas fa-user"></i>Hak Akses
                                </a>
                            </li>
    ...
    <?php
        ...
        if($page == "") {
            ...
            if($action == "") {
                ...
                include "pegawai pns/insert.php";
            }else if($action == "update") {
                include "pegawai pns/update.php";
            }else if($action == "delete") {
                include "pegawai pns/delete.php";
            }else if($action == "kuota_cuti") {
                include "pegawai pns/kuota_cuti.php";
            }
        }else if($page == "pegawai_honor") {
            if($action == "") {
                include "pegawai honor/pegawai_honor.php";
            }else if($action == "insert") {
                include "pegawai honor/insert.php";
            }else if($action == "update") {
                include "pegawai honor/update.php";
            }else if($action == "delete") {
                include "pegawai honor/delete.php";
            }
        }else if($page == "absensi") {
            if($action == "") {
                include "absensi/absensi.php";
            }else if($action == "insert") {
                include "absensi/insert.php";
            }else if($action == "update") {
                include "absensi/update.php";
            }else if($action == "delete") {
                include "absensi/delete.php";
            }
        }else if($page == "hak_akses") {
            if($action == "") {
                include "hak akses/hak_akses.php";
            }else if($action == "insert") {
                include "hak akses/insert.php";
            }else if($action == "update") {
                include "hak akses/update.php";
            }else if($action == "delete") {
                include "hak akses/delete.php";
            }
        }else if($page == "laporan_data_pegawai") {
            if($action == "") {
                include "laporan/laporan_data_pegawai.php";
            }
        }else if($page == "laporan_absensi_pegawai") {
            if($action == "") {
                include "laporan/laporan_absensi_pegawai.php";
            }
            ...
            }else if($action == "cetak_surat_peringatan") {
                include "surat cuti/cetak_surat_peringatan.php";
            }
        }
