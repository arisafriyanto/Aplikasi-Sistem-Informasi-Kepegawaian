...
$content .= "
    ...
    $content .= "
                    ...
                    <div style=' padding-left: 20px; text-align: center; font-size:18px;'>
                        Dengan ini saya mengajukan untuk izin ". selisih_tanggal($data['dari_tgl'], $data['sampai_tgl']) ." hari  dari tanggal ".date('d F Y', strtotime($data['dari_tgl'] ))." <br><br>
                    ...
                    Demikian surat izin ini kami ajukan untuk dapat dipertimbangkan,<br><br>
